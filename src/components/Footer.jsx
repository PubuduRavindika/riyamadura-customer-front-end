            ...
            <div className="flex space-x-4">
              {socialLinks.map((social) => (
                <a
                  key={social.name}
                  href={social.href}
                  className="w-10 h-10 bg-gray-800 hover:bg-ai-500 rounded-full flex items-center justify-center transition-colors duration-200"
